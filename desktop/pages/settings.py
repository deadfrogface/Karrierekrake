...
class SettingsPage(QWidget):
    ...
    def __init__(self, config_service: ConfigService, parent=None) -> None:
        ...
        self.guenther_model.addItem("Standard", "qwen3-4b")
        self.guenther_model.addItem("Alternative", "phi4-mini")
    ...
    def retranslate_ui(self) -> None:
        ...
        if hasattr(self, "guenther_box"):
            ...
            self.guenther_model.addItem(tr("settings.guenther_model.standard"), "qwen3-4b")
            self.guenther_model.addItem(tr("settings.guenther_model.alt"), "phi4-mini")
