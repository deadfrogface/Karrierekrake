#!/usr/bin/env python3
"""Round7 sealed regression extract after Phase-3 prompt/norm fixes.

REGRESSION on known CVs — NOT an independent blind test / NOT a 99% claim.
Writes to tests/docpick_qwen35/regression_known_cvs_round7/.
"""
...
def main() -> int:
    ...
    freeze = {
        "seal_type": "PARSER_CONFIG_SCORER_FREEZE_ROUND7",
        ...
        "changes": [
            ...
            "revert_minified_json_prompt",
            "keep_round3_system_prompt_and_postprocess",
            "max_tokens_2048",
        ],
        "llm": {
    ...
    seal = {
        "seal_type": "PHASE_A_PREDICTION_SEAL_ROUND7",
        "test_type": "REGRESSION_KNOWN_CVS_NOT_BLIND",
        "disclaimer": "Known CVs only. Not independent blind. Not a 99% claim.",
        "created_at": datetime.now(timezone.utc).isoformat(),
        "gt_not_loaded": True,
