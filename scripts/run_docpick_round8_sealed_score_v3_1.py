#!/usr/bin/env python3
"""Score sealed Round8 Docpick predictions with COMPLETE_GT_ONLY_V3_1_DATE_NORM.
...
Round8 = re-extract after education schema/order + section enrich + narrow heute repair.
"""
...
OUT = ROOT / "tests" / "docpick_qwen35" / "regression_known_cvs_round8"
...
def main() -> int:
    ...
    assert seal.get("seal_type") == "PHASE_A_PREDICTION_SEAL_ROUND8"
    ...
    out = {
        ...
        "disclaimer": (
            "Round8 re-extract after education schema/order + section enrich + "
            "narrow same-block heute repair. "
