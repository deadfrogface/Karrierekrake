#!/usr/bin/env python3
"""Round5 sealed regression extract after Phase-3 prompt/norm fixes.

REGRESSION on known CVs — NOT an independent blind test / NOT a 99% claim.
Writes to tests/docpick_qwen35/regression_known_cvs_round5/.
"""
...
OUT = ROOT / "tests/docpick_qwen35/regression_known_cvs_round5"
...
def main() -> int:
    ...
    freeze = {
        "seal_type": "PARSER_CONFIG_SCORER_FREEZE_ROUND5",
        ...
        "changes": [
            "revert_round4_prompt_to_round3",
            "full_schema_default",
            "dob_enrich_from_text",
            "repair_invented_heute_from_dated_range",
            "normalize_driving_license_helper",
            "keep_address_software_employment_postprocess",
            "max_tokens_2048",
        ],
        "llm": {
    ...
    seal = {
        "seal_type": "PHASE_A_PREDICTION_SEAL_ROUND5",
        "test_type": "REGRESSION_KNOWN_CVS_NOT_BLIND",
        "disclaimer": "Known CVs only. Not independent blind. Not a 99% claim.",
        "created_at": datetime.now(timezone.utc).isoformat(),
        "gt_not_loaded": True,
