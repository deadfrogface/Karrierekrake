#!/usr/bin/env python3
"""Score sealed Round4 Docpick predictions with COMPLETE_GT_ONLY_V3_1_DATE_NORM.
...
Round4 = re-extract after Round4 postprocess+prompt address/employment/software fixes.
"""
...
def main() -> int:
    ...
    assert seal.get("seal_type") == "PHASE_A_PREDICTION_SEAL_ROUND4"
    ...
    out = {
        ...
        "disclaimer": (
            "Round4 re-extract after Phase-3 present→heute norm + schema/prompt fixes. "
