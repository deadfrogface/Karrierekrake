#!/usr/bin/env python3
"""Round3 sealed regression extract after Phase-3 prompt/norm fixes.

REGRESSION on known CVs — NOT an independent blind test / NOT a 99% claim.
Writes to tests/docpick_qwen35/regression_known_cvs_round3/.
"""
...
def main() -> int:
    ...
    freeze = {
        "seal_type": "PARSER_CONFIG_SCORER_FREEZE_ROUND3",
        ...
        "changes": [
            "async_cv_dialog",
            "docling_content_hash_cache",
            "present_to_heute_norm",
            "schema_position_end_date_hints",
        ],
        "llm": {
    ...
    seal = {
        "seal_type": "PHASE_A_PREDICTION_SEAL_ROUND3",
        "test_type": "REGRESSION_KNOWN_CVS_NOT_BLIND",
        "disclaimer": "Known CVs only. Not independent blind. Not a 99% claim.",
        "created_at": datetime.now(timezone.utc).isoformat(),
        "gt_not_loaded": True,
