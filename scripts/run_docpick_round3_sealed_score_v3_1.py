#!/usr/bin/env python3
"""Score sealed Round3 Docpick predictions with COMPLETE_GT_ONLY_V3_1_DATE_NORM.
...
Round3 = re-extract after Phase-3 present→heute + schema/prompt fixes.
"""
...
def main() -> int:
    ...
    assert seal.get("seal_type") == "PHASE_A_PREDICTION_SEAL_ROUND3"
    ...
    out = {
        ...
        "disclaimer": (
            "Round3 re-extract after Phase-3 present→heute norm + schema/prompt fixes. "
