#!/usr/bin/env python3
"""Score sealed Round7 Docpick predictions with COMPLETE_GT_ONLY_V3_1_DATE_NORM.
...
Round7 = re-extract after Round7 postprocess+prompt address/employment/software fixes.
"""
...
OUT = ROOT / "tests" / "docpick_qwen35" / "regression_known_cvs_round7"
...
def main() -> int:
    ...
    assert seal.get("seal_type") == "PHASE_A_PREDICTION_SEAL_ROUND7"
    ...
    out = {
        ...
        "disclaimer": (
            "Round7 re-extract after Phase-3 present→heute norm + schema/prompt fixes. "
