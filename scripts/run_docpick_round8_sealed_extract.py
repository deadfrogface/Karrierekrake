#!/usr/bin/env python3
"""Round8 sealed regression extract after education/heute postprocess fixes.

REGRESSION on known CVs — NOT an independent blind test / NOT a 99% claim.
Writes to tests/docpick_qwen35/regression_known_cvs_round8/.
"""
...
def main() -> int:
    ...
    freeze = {
        "seal_type": "PARSER_CONFIG_SCORER_FREEZE_ROUND8",
    ...
    seal = {
        "seal_type": "PHASE_A_PREDICTION_SEAL_ROUND8",
        "test_type": "REGRESSION_KNOWN_CVS_NOT_BLIND",
        "disclaimer": "Known CVs only. Not independent blind. Not a 99% claim.",
        "created_at": datetime.now(timezone.utc).isoformat(),
        "gt_not_loaded": True,
