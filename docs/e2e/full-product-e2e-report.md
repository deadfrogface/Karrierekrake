...
| REAL WINDOWS BLACK-BOX USER ACCEPTANCE | **NOT RUN** (NEXT-06: `tests/blackbox`) |
...
| REAL GOOGLE MAPS ROUTING | **CODE READY / BLACK-BOX NOT RUN** |
| REAL PRIVATE CV IMPORT THROUGH PACKAGED EXE | **NOT PASSED** |
| REAL EXTERNAL INTEGRATION E2E | **NOT RUN** |

**Suite label:** SYNTHETIC / OFFLINE E2E REGRESSION SUITE — keep it; do **not**
treat a green run as full real-product acceptance.
